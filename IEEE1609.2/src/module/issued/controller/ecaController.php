...
class ecaController
{
    ...
    public function submitAction()
    {
		...
		$conf = array(
			...
			,"output_file_path"		=> "/workdir/srcs/output/".$_POST["issuer_cert"]."/eca/".$dirname."/eca.cert"
			,"cert_id"				=> array(
		...
		// run
		chdir("/workdir/srcs");
		exec("mkdir -p /workdir/srcs/output/".$_POST["issuer_cert"]."/eca/".$dirname);
		...
		// compress
		exec("zip -jr /var/www/scms2016gui/public/downloads/eca_".$dirname.".zip /workdir/srcs/output/".$_POST["issuer_cert"]."/eca/".$dirname);

		$result = array(
			 "result" => "success"
			,"download_path"	=> "/downloads/eca_".$dirname.".zip"
		);
