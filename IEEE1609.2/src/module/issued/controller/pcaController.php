...
class pcaController
{
    ...
    public function submitAction()
    {
		...
		$conf = array(
			...
			,"output_file_path"		=> "/workdir/srcs/output/".$_POST["issuer_cert"]."/pca/".$dirname."/pca.cert"
			,"cert_id"				=> array(
		...
		// run
		chdir("/workdir/srcs");
		exec("mkdir -p /workdir/srcs/output/".$_POST["issuer_cert"]."/pca/".$dirname);
		...
		// compress
		exec("zip -jr /var/www/scms2016gui/public/downloads/pca_".$dirname.".zip /workdir/srcs/output/".$_POST["issuer_cert"]."/pca/".$dirname);

		$result = array(
			 "result" => "success"
			,"download_path"	=> "/downloads/pca_".$dirname.".zip"
		);
